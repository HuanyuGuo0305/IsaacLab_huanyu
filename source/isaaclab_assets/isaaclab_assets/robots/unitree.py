...
UNITREE_B2W_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/Unitree/B2W/usd/b2w.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_B2WZ1_HIGHGAINS_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "z1_arm_joint14": DCMotorCfg(
            joint_names_expr=["joint1", "joint4"],
            effort_limit=30.0,
            saturation_effort=30.0,
            velocity_limit=2.0,
            stiffness=76.8,
...
UNITREE_B2WZ1_HIGHGAINS_PITCH_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/Unitree/B2WZ1/usd/b2wz1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
