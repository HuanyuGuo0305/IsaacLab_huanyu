...
class UnitreeB2WZ1PLBTrajLocoManipCommandsCfg():
    ...
    ee_kp = mdp.PresampledKeypointsCubicTrajectoryCommandPLBCfg(
        ...
        debug_vis=True,
        file_path="scripts/tools/keypoints_plb_pickup.npy",
        sample_mode="random",
        kp_dx=0.30,
        kp_dz=0.30,
        ground_z=0.0,
...
class UnitreeB2WZ1PLBTrajLocoManipEventCfg(EventCfg):
    ...
    reset_arm_joint_offset_gripper = EventTerm(
        func=mdp.reset_joints_by_offset,
        mode="reset",
        params={
            "asset_cfg": SceneEntityCfg("robot", joint_names=["jointGripper"]),
            "position_range": (-1.5, 0.0), 
            "velocity_range": (0.0, 0.0),
        }
    )
...
class UnitreeB2WZ1PLBTrajLocoManipCurriculumCfg():
    ...
    ee_lin_vel_weight_200 = CurrTerm(
        ...
        params={
            ...
            "modify_params": {"start": -0.05, "end": -1.0, "start_step": 4800, "end_step": 12000},
        },
    )
    ...
    ee_ang_vel_weight_200 = CurrTerm(
        ...
        params={
            ...
            "modify_fn": ramp_value,
            "modify_params": {"start": -0.02, "end": -0.20, "start_step": 4800, "end_step": 12000},
        },
    )
    ...
    ee_lin_acc_weight_200 = CurrTerm(
        ...
        params={
            ...
            "modify_fn": ramp_value,
            "modify_params": {"start": -0.0001, "end": -0.0050, "start_step": 4800, "end_step": 12000},
        },
    )
    ...
    arm_dof_acc_weight_200 = CurrTerm(
        ...
        params={
            ...
            "modify_fn": ramp_value,
            "modify_params": {"start": -5.0e-06, "end": -1.0e-04, "start_step": 4800, "end_step": 12000},  # -1,0e-05
        },   
    )
